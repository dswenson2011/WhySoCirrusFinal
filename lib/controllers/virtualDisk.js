...
function CreateVD(req, res) {
	host.object = {};
	host.object.Path = "D:\\VHDS\\Guest\\" + req.body.vd.name + ".vhdx";
	host.object.ParentPath = "D:\\VHDS\\Master\\" + req.body.vd.operatingSystem + ".vhdx";
	host.object.Size = String(parseInt(req.body.vd.size) * 1000000000);
	...
	edge.func('ps', function () {
		...
		function a($input){$input = $input | ConvertTo-JSON | ConvertFrom-Json; New-VHD -Path $input.Path -ParentPath $input.ParentPath -SizeBytes $input.Size -Differencing | ConvertTo-JSON}
